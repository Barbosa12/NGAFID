...
fault-discriminative information concentrates in components 12--18, which
together account for \textbf{less than 0.1\% of total variance}. The dominant
components (PCs 1--11) capture operational variability common to both healthy and
anomalous flights---altitude profile, throttle inputs, ambient temperature
effects---and actively \textit{mask} the fault signatures that classifiers need
to detect.
