...
\begin{enumerate}
    ...
    \item A hierarchical fault classification experiment (Oracle K\,=\,4) that
          raises the classical ceiling from a flat best of F1\,=\,0.207 to
          F1\,=\,0.459 through physics-based fault grouping, closing over half the
          gap to the DL best (MMK~Net, F1\,=\,0.623) without any temporal modeling.
    \item An end-to-end error decomposition showing that Stage~2 wrong-type errors
          are the single largest error category (20.0\% of predictions),
          identifying fault classification as the bottleneck for future improvement.
\end{enumerate}
...
hierarchy of representations from global statistics to segmented and
cross-physical features.
