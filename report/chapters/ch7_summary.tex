...
\begin{itemize}
    ...
    \item \textbf{The remaining gap is temporal in nature.} Global statistics and
          ...
          fault signatures are local micro-patterns living in low-variance
          principal components (PC9 and PC19--23, $<$0.1\% of variance). Locally
          restricted temporal deep learning is the indicated route to close it.
